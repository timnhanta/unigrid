...
import (
	...
	"github.com/TimNhanTa/unigrid/x/vesting/types"
...
func GetTxCmd() *cobra.Command {
	...
	txCmd.AddCommand(
		...
		//NewMsgCreateCustomVestingAccountCmd(),
	)
...
func NewMsgCreateCustomVestingAccountCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "create-unigrid-vesting-account [to_address] [amount] [start_time] [duration] [parts]",
...
set by the committed block's time. The start_time must be provided as a UNIX epoch
timestamp.`,
